...
class Particle {
	...
	update() {
		...
		if (this.size < 0) {
			...
			// default addition increased from 2 to 12, 5 to 15
...
function swRegistration() {
	...
	if ("serviceWorker" in navigator) {
		navigator.serviceWorker
			.register("/mousetrail-particle2/sw.js", {
				scope: "/mousetrail-particle2/",
			})
...
function consoleText() {
	...
	console.log("%cThe README   %chttps://bit.ly/3S7fCjy", gradient, styles2);
